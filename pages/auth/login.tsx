        ...
        <div className='ani-showpage'>
            <ThemeProvider theme={theme}>
                <div className="bg-white h-screen flex justify-center items-center flex-col p-2">
                    <Button sx={{ alignSelf: "start", mb: "auto" }}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="25" height="24" fill="currentColor" className="bi bi-house-fill mx-2" viewBox="0 0 16 16">
                    ...
                    <form className="p-4 flex justify-center items-start flex-col mb-auto">
                        ...
                        <Button variant='contained' sx={{ borderRadius: 50, mt: 2.4, p: 2, mb: 10 }} fullWidth>تایید</Button>
